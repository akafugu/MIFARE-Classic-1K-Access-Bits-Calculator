WidgetCallback([
   {
       ...
       "datasector": { 
       		...
       		"note" : "<sup>1</sup> if Key B may be read in the corresponding Sector Trailer it cannot serve for authentication (all grey marked lines in previous table). As a consequences, if the reader authenticates any block of a sector which uses the grey marked access conditions and using key B, the card will refuse any subsequent memory access after authentication."
   	   },
   	   "copyright" : "HTMLified by <a href=\"http://akafugu.jp\">Akafugu Corporation</a>.<br/>The information is taken from <a href=\"http://www.nxp.com/documents/data_sheet/MF1S503x.pdf\">MF1S503x</a> from NXP Seiconductors." 
   }
]);